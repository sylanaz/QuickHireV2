...
const DescBTN = ({ text, userData }) => {
  ...
  const style = text == "ยินดีด้วยนะ" ? "bg-green-500" : text == "เสียใจด้วยนะ" ? "bg-red-500" : "bg-[#F0E9D5] text-[#F27F0C]";
// text-[#F27F0C]
  return (
    <div className="flex w-full justify-center mb-2 mt-1 xl:mb-3 xl:mt-2">
      <div className={`flex justify-center items-center py-[0.35rem] underline underline-offset-1 decoration-2 text-base px-[3px] font-bold w-full rounded-xl ${style} md:text-lg xl:text-2xl md:w-11/12`}>
