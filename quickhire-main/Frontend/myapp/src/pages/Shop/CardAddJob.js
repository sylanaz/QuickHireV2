...
const CardAddJob = () => {
  ...
  return (
    ...
    <Link to="/Create" className="flex flex-col border-4 border-[#6C8C9C] bg-[#C7EFF6] justify-center items-center max-w-xs max-h-[19rem] md:max-h-[40rem] mx-3 my-3 rounded-[20px] md:rounded-[40px] cursor-pointer">
      {/* <div className=""> */}
