    ...
    <section className="bg-gray-50 min-h-screen flex items-center justify-center ">
      <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-5xl p-5 items-center">
        ...
        <div className="md:w-1/2 px-8 md:px-16">
          <h2 className="flex items-center justify-center font-bold text-2xl text-center text-[#002D74]">
            สำหรับ<span className="text-yellow-500">ผู้สมัครงาน</span>
          </h2>

          <form action="" className="flex flex-col flex-wrap gap-4">
            <div className="flex mt-8 ">
              <input type="text" name="firstname" placeholder="ชื่อจริง" className="p-2 rounded-xl border"></input>
              <input type="text" name="surname" placeholder="นามสกุล" className="p-2 rounded-xl border"></input>
              <input type="text" name="email" placeholder="อีเมล์" className="p-2 rounded-xl border"></input>
              <input type="password" name="password" placeholder="รหัสผ่าน" className="p-2 rounded-xl border "></input>
              <input type="password" name="password" placeholder="รหัสผ่าน" className="p-2 rounded-xl border "></input>
              <input type="password" name="password" placeholder="รหัสผ่าน" className="p-2 rounded-xl border "></input>
              <input type="password" name="password" placeholder="รหัสผ่าน" className="p-2 rounded-xl border"></input>
              <div className="relative">
                {/* <input type="password" name="password" placeholder="นามสกุล" className="p-2 rounded-xl border w-full"></input> */}
